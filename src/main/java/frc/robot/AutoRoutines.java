...
public class AutoRoutines {
  ...
  public AutoRoutine PedriShortRight() {
    ...
    intakeToShoot1
        .done()
        .onTrue(Commands.sequence(returnBasicShoot(redSide).withTimeout(4.0), shootToBump.cmd()));
  ...
  public AutoRoutine PedriShortLeft() {
    ...
    AutoTrajectory intake2 = intake(routine, Constants.Swerve.Auto.Intake.RightIntakeSweep);
